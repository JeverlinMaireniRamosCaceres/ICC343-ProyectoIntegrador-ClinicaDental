<div id="sidebar-container" class="d-flex flex-column shadow">
    ...
    <ul class="nav flex-column sidebar-nav flex-grow-1">
        ...
        <li>
            <a href="{{ route('odontologos.index') }}" class="nav-link {{ request()->routeIs('odontologos.*') ? 'active' : '' }}">
        ...
        <li>
            ...
            <ul class="collapse submenu {{ request()->routeIs('compras.*') || request()->routeIs('proveedores.*') || request()->routeIs('productos.*') ? 'show' : '' }}" id="invSubmenu">
                <li>
        ...
        <li>
            <a href="{{ route('caja-chica.index') }}" class="nav-link {{ request()->routeIs('caja-chica.*') ? 'active' : '' }}">
        ...
        <li>
            ...
            <ul class="collapse submenu {{ request()->routeIs('usuarios.*') || request()->routeIs('procedimientos.*') || request()->routeIs('alergias.*') || request()->routeIs('especialidades.*') ? 'show' : '' }}" id="configSubmenu">
                <li>
                ...
                <li>
                    <a class="nav-link {{ request()->routeIs('procedimientos.*') ? 'active' : '' }}" href="{{ route('procedimientos.index') }}">
                        <i class="bi bi-clipboard2-plus"></i>
                        <span class="link-text">Procedimientos</span>
                    </a>
                </li>
                <li>
                    <a class="nav-link {{ request()->routeIs('especialidades.*') ? 'active' : '' }}" href="{{ route('especialidades.index') }}">
                        <i class="bi bi-award"></i>
                        <span class="link-text">Especialidades</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('alergias.index') }}" class="nav-link {{ request()->routeIs('alergias.*') ? 'active' : '' }}">
