                    ...
                    <tr>
                        <td style="padding: 32px;">
                            ...
                            <p style="margin: 0 0 24px; color: #495057; font-size: 15px; line-height: 1.6;">
                                Adjuntamos el recibo correspondiente al pago realizado.
                                ...
                                <tr>
                                    <td style="padding: 16px 20px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="color: #6c757d; font-size: 13px; padding-bottom: 6px;">
                                                    N.º de recibo
                                                </td>
                                                ...
                                                <td
                                                    ...
                                                    REC-{{ str_pad($pago->idPago, 6, '0', STR_PAD_LEFT) }}
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    FAC-{{ str_pad($pago->factura->idFactura, 6, '0', STR_PAD_LEFT) }}
