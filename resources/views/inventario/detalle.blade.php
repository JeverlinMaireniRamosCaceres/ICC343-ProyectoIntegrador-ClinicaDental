...
@section('content')
    <div class="container-fluid py-4 px-5">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            <a href="{{ route('inventario.index') }}" class="btn btn-sm rounded-circle"
        ...
        @if($producto->descripcion)
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-body p-4">
                    <p class="text-muted small fw-semibold mb-1 text-uppercase" style="letter-spacing:.05em; font-size:11px;">
                        Descripción</p>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            @forelse($producto->detallesCompra as $lote)
                                @php
                                    $agotado = $lote->cantidadDisponible <= 0;
                                    $vencido = false;
                                    $proximoVencer = false;
                                ...
                                <tr>
                                    ...
                                    <td class="px-4">
                                        <div class="fw-semibold">
                                            ...
                                            <span class="text-muted fw-normal small">/ {{ $lote->cantidad }}</span>
                                        </div>
                                    </td>
